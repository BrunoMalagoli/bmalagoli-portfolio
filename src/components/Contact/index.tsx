import IconLinkedinAlt from "./components/IconComponents/LinkedInIcon";
import IconMail from "./components/IconComponents/MailIcon";
    ...
    <>
      ...
      <Element name="contacto">
        <div className={ContactStyles.waveContainer}>
          <div
            className={ContactStyles["custom-shape-divider-bottom-1689571958"]}
          >
            <svg
              data-name="Layer 1"
            ...
            >
              <path
                ...
                opacity=".25"
                className={ContactStyles["shape-fill"]}
              ></path>
              <path
